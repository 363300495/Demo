...
- (void)initData{
    ...
    [HttpService loadDataShareLogPostPage:page uid:uid token:token versionCode:versionCode devType:@"2" timeStamp:timeStamp randCode:randCode sign:sign sucess:^(id responseObject) {
...
- (void)onClickMore{
    ...
    MyShareRecordController *myShareRecordVC = [[MyShareRecordController alloc] init];
    [self.navigationController pushViewController:myShareRecordVC animated:YES];
